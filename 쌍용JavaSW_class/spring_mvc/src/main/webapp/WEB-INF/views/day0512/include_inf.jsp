...
<div>
	...
	액션테그: <jsp:include page="/WEB-INF/views/include/include_a.jsp"/><br/>
	액션테그: <jsp:include page="/include/include_b.jsp" /><br/>
	<p>---------------------------------------------------</p><br/>
	jstl: <c:import url="/WEB-INF/views/include/include_a.jsp"/><br/>
	jstl: <c:import url="/include/include_b.jsp" /><br/>
</div>
외부 페이지
</body>
</html>