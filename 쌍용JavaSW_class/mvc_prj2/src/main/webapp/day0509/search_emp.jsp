...
<a href="search_emp.do?cmd=I001&deptno=0">모든 사원정보</a><br/>

<c:if test="${param.deptno eq '0'}">모든 사원 정보 조회</c:if>
<c:if test="${param.deptno ne '0'}">
	<strong><c:out value="${param.deptno}" />번 부서에 근무하는 사원 정보 조회</strong>
</c:if>
