...
<body>
<form name="frm" action="http://localhost/jsp_prj/jsp0413/usebean_process.jsp" method="get">
<div>
...
<form name="postFrm" action="http://localhost/jsp_prj/jsp0413/usebean_process.jsp" 
	method="post">
<div>
<strong>HTML Form Control 값 받기</strong><br/>
<label>text</label> <input type="text" name="text" class="inputBox"/><br/>
